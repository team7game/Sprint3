...
1. Download zip of Sprint3 repository.
2. Unzip the folder.
3. The unziped folder should have two jar files within it.
4. Double click on Sprint3.jar to run the code.

Option 2 (Backup Method):
1. Download zip of Sprint3 repository.
2. Unzip the folder.
3. In command prompt, navigate to the src folder within the Sprint3 folder.
